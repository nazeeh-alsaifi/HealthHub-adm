        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('expert_predict')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="expert-row form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="text" class="form-control @error('age') is-invalid @enderror"
                                           name="discrete_age" value="{{ old('age') }}" required autocomplete="age"
                                           autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="expert-radio-button">
                                    <input id="chest_pain_type" type="radio"
                                           class="form-control @error('chest_pain_type') is-invalid @enderror"
                                           name="chest_pain_type" value="asympt" checked required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="chest_pain_type" type="radio"
                                           class="form-control @error('chest_pain_type') is-invalid @enderror"
                                           name="chest_pain_type" value="atyp_angina" required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="chest_pain_type" type="radio"
                                           class="form-control @error('chest_pain_type') is-invalid @enderror"
                                           name="chest_pain_type" value="non_anginal" required autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="discrete_rest_blood" type="text"
                                           class="form-control @error('discrete_rest_blood') is-invalid @enderror"
                                           name="discrete_rest_blood" value="{{ old('discrete_rest_blood') }}" required
                                           autocomplete="discrete_rest_blood" autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="expert-radio-button">
                                    <input id="blood_sugar" type="radio"
                                           class="form-control @error('blood_sugar') is-invalid @enderror"
                                           name="blood_sugar" value="yes" checked required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="blood_sugar" type="radio"
                                           class="form-control @error('blood_sugar') is-invalid @enderror"
                                           name="blood_sugar" value="no" required autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="expert-radio-button">
                                    <input id="rest_electro" type="radio"
                                           class="form-control @error('rest_electro') is-invalid @enderror"
                                           name="rest_electro" value="normal" checked required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="rest_electro" type="radio"
                                           class="form-control @error('rest_electro') is-invalid @enderror"
                                           name="rest_electro" value="left_vent_hyper" required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="rest_electro" type="radio"
                                           class="form-control @error('rest_electro') is-invalid @enderror"
                                           name="rest_electro" value="st_t_wave_abnormality" required autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="discrete_max_heart" type="text"
                                           class="form-control @error('discrete_max_heart') is-invalid @enderror"
                                           name="discrete_max_heart" value="{{ old('discrete_max_heart') }}" required
                                           autocomplete="discrete_max_heart" autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="expert-radio-button">
                                    <input id="exercice_angina" type="radio"
                                           class="form-control @error('exercice_angina') is-invalid @enderror"
                                           name="exercice_angina" value="yes" checked required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="exercice_angina" type="radio"
                                           class="form-control @error('exercice_angina') is-invalid @enderror"
                                           name="exercice_angina" value="no" required autofocus>
                            ...
                            <div class="expert-row form-group row">
                                ...
                                <div class="expert-radio-button">
                                    <input id="expert-algorithm" type="radio"
                                           class="form-control @error('expert-algorithm') is-invalid @enderror"
                                           name="expert_algorithm" value="id3" checked required autofocus>
                                ...
                                <div class="expert-radio-button">
                                    <input id="expert-algorithm" type="radio"
                                           class="form-control @error('expert-algorithm') is-invalid @enderror"
                                           name="expert_algorithm" value="bayes" required autofocus>
                            ...
                            @if(isset($result) && $result == 'false')
                                <div class="expert-row form-group row ">
                                    <div class="col-md-6 offset-md-4 ">
                                        <button type="button" class="btn btn-success input-label" disabled>
                                            Algorithm Result: You Dont't Have a Disease :)
                                        </button>
                                    </div>
                                </div>
                            @elseif(isset($result) && $result == 'true')
                                <div class="expert-row form-group row ">
                                    <div class="col-md-6 offset-md-3 ">
                                        <button type="button" class="btn btn-danger input-label" disabled>
                                            Algorithm Result: You Have a Disease :( Please Choose Another Algorithm To Make Sure.
                                        </button>
                                    </div>
                                </div>
                            @endif
