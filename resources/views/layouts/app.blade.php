...
<div id="header-bottom" class="d-flex align-items-center header-transparent">
    <div  class="container d-flex align-items-center">
...
{{--    <!-- The Main Symbol HEALTH HUB  svg-->--}}
{{--    <div id="header-mid" class="jumbotron text-center bg-light" style="margin-bottom:0">--}}
{{--        <div class="title  p-md-3 mr-auto">--}}
{{--            <svg id="logo" width="556" height="74" viewBox="0 0 556 74" fill="none"--}}
{{--                 xmlns="http://www.w3.org/2000/svg">--}}
...
{{--    <div id="header-trending" class="fixed-top d-flex align-items-center  header-transparent ">--}}
{{--        <div class="container d-flex align-items-center">--}}
