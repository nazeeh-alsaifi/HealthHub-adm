            ...
            <div class="slider">
                @foreach($most_viewed as $article)
                    ...
                    <div class="slide active-slide"
                         style="background-image: url('/public/images/{{$article->image}}')">
            ...
            <div id="consult-form">
                <div class="row justify-content-center">
                    <div class="py-4 col-md-8 col-md-12">
                        <div class="card">
                            <div class="card-header text-center font-weight-bolder"><span class="card_header_text">Write Your Consult</span>
                            </div>
            ...
            <div id="admin-replies">
                <div class="row justify-content-center">
                    <div class="py-4 col-md-8 col-lg-12">
                        <div class="card ">
                            <div class="card-header text-center font-weight-bolder"><span class="card_header_text"> My Conultations </span>
                            </div>
                            <div class="row">
