...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6 mb-2 mt-2">
                                <div class="smaller-card card h-100">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="{{route('article_show',$username ?? '')}}">Article One</a>
                                        </h4>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-2 mt-2">
                                <div class="smaller-card card h-100">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="{{route('article_show',$username ?? '')}}">Article Two</a>
                                        </h4>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-2 mt-2">
                                <div class="smaller-card card h-100">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="{{route('article_show',$username ?? '')}}">Article Three</a>
                                        </h4>
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                            Quos
                            ...
                            <div class="col-lg-4 col-sm-6 mb-2 mt-2">
                                <div class="smaller-card card h-100">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="{{route('article_show',$username ?? '')}}">Article Four</a>
                                        </h4>
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Nam
                                            viverra euismod odio, gravida pellentesque urna varius vitae.</p>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-2 mt-2">
                                <div class="smaller-card card h-100">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="{{route('article_show',$username ?? '')}}">Article Five</a>
                                        </h4>
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Nam
                                            viverra euismod odio, gravida pellentesque urna varius vitae.</p>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-2 mt-2">
                                <div class="smaller-card card h-100">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <a href="{{route('article_show',$username ?? '')}}">Article Six</a>
                                        </h4>
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
    ...
    @if(!(Auth::user() == null))
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach( Auth::User()->sent as $message)
                                        <tr class="accordion-toggle collapsed" id="accordion1">
                                            <td class="expand-button" data-toggle="collapse" href="#{{'collapse'. $message->id}}"></td>
                                            <td>{{$message->subject}}</td>
                                            <td>{{ $message->sender->name}}</td>
                                            <td>{{$message->created_at}}</td>
                                            <td><p id="reply-link" data-toggle="collapse" href="#test">View Reply</p></td>
                                        </tr>
        ...
        <div id="admin-replies" style="padding: 30px">
            <div class="row justify-content-center">
                <div class="py-4 col-md-8">
                    <div class="card-header">Admin Replies</div>
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 mb-2 mt-2">
                            <div class="table-responsive">
                                <table class="table table-hover">
